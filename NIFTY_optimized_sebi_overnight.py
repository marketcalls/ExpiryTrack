...
MARGIN_NORMAL_BASE     = 136_000   # Normal day spread margin at base spot
MARGIN_ELM_EFFECTIVE   = 60_000   # ELM increment on hedged spread at base spot
...
def run_simulation(df, provider, st_period, st_mult, spread_width):
    ...
    def _try_enter_spread(bar_time, bar_date, spot, direction, provider, spread_width):
        ...
        nonlocal skipped_no_contract, skipped_no_price, skipped_negative_credit,             skipped_used_next_expiry, skipped_margin
