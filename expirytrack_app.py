...
def index():
    ...
    return render_template('index_expiry.html',
...
def settings():
    ...
    return render_template('settings_expiry.html', credential=credential, has_credentials=has_credentials)
...
def dashboard():
    ...
    return render_template('dashboard_expiry.html',
                         stats=stats,
