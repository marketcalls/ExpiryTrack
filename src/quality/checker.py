...
class QualityViolation:
    ...
    def __init__(self, check: str, severity: str, message: str,
                 instrument_key: str = '', details: Optional[Dict] = None):
        self.check = check
...
class DataQualityChecker:
    ...
    def run_all_checks(self, instrument_key: Optional[str] = None) -> QualityReport:
    ...
    def _check_ohlc_integrity(self, conn, report: QualityReport, instrument_key: Optional[str]):
    ...
    def _check_negative_values(self, conn, report: QualityReport, instrument_key: Optional[str]):
    ...
    def _check_zero_volume(self, conn, report: QualityReport, instrument_key: Optional[str]):
    ...
    def _check_price_spikes(self, conn, report: QualityReport, instrument_key: Optional[str]):
    ...
    def _check_gap_days(self, conn, report: QualityReport, instrument_key: Optional[str]):
    ...
    def _check_duplicate_timestamps(self, conn, report: QualityReport, instrument_key: Optional[str]):
    ...
    def _check_orphan_contracts(self, conn, report: QualityReport, instrument_key: Optional[str]):
    ...
    @staticmethod
    def _instrument_filter(instrument_key: Optional[str]) -> Tuple[str, list]:
