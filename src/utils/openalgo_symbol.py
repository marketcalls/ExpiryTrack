...
class OpenAlgoSymbolGenerator:
    ...
    def format_expiry_date(expiry_date: str) -> str:
        ...
        try:
            ...
            logger.error(f"Error formatting date {expiry_date}: {e}")
            return expiry_date
    ...
    @staticmethod
    def generate_future_symbol(trading_symbol: str, expiry_date: str, instrument_key: str = None) -> str:
        """
    ...
    def generate_option_symbol(
        trading_symbol: str, expiry_date: str, strike_price: float, option_type: str, instrument_key: str = None
    ) -> str:
        """
    ...
    def generate_symbol(contract: dict) -> str:
        ...
        if instrument_type.upper() in ["FUT", "FUTURE", "FUTURES"]:
            return OpenAlgoSymbolGenerator.generate_future_symbol(base_symbol, expiry, contract.get("instrument_key"))
            ...
            return OpenAlgoSymbolGenerator.generate_option_symbol(
                base_symbol, expiry, strike_price, option_type, contract.get("instrument_key")
            )
        else:
    ...
    def parse_openalgo_symbol(openalgo_symbol: str) -> dict:
        ...
        try:
            ...
            logger.error(f"Error parsing OpenAlgo symbol {openalgo_symbol}: {e}")
